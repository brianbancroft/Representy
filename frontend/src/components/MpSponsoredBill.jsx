...
var MpSponsoredBill = React.createClass({
    ...
    render: function() {
        ...
        return (
            <div>
                <ReactTooltip data-multiline='true'/> {(this.props.mp.sponsored_bill_tally >= 1)
                    ? <div className="row-item">
                            <h2>Sponsored Bills
                                <span data-multiline='true' data-tip="Bills introduced by this MP." className="icon icon-help-circled"></span>
                            </h2>
