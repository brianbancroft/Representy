...
<br/>0-3: Not much engagement. 4-7: Some cross-talk 8-10: Loves to talk amongst the tweeple!" className={"score-num " + tweetTag}>{tweetScore}</span>
                    <span>{(this.props.mp.twitter !== '')
                            ? <a target="_blank" href={'http://twitter.com/' + this.props.mp.twitter}>
                                    <span className='icon icon-twitter-bird'></span>
                                    {this.props.mp.twitter}</a>
                            : ''}</span>
                </div>
